...
public class Map {
    ...
    List<Monster> tableauDeMonstres = new ArrayList<>();
    	...
    	for(int i = 0 ; i < 38;i++) {
    		for(int j = 0;j<22;j++) {
				...
				case "merchant" :
    					...
    					break;
				case "potionGreen" :
                    Items G = new Items("potionGreen", "Se boit.","Drink");
				...
				case "potionYellow" :
                    ...
                    break;
                case "potionPurple" :
                    Items P = new Items("potionPurple", "Se boit.","Drink");
                    gridpane.add(P.getImageView(),i,j);
                    break;
				case "nothing" :
					break;
				default :
